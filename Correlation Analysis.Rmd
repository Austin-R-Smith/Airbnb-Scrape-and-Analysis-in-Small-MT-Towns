...
For the most part, these distributions are also right skewed. 
...
Note that the distributions of ages under 18 and 18-34 become less normally distributed with a log transformation. For my correlation analysis, I will not log transform those two variables. 
...
par(mfrow=c(2,2))
# log transformed listings vs. under 18 
plot(log10(ZoomMeans)~(`%under_eighteen`),data=pared_ages_df,main = "%age Under 18 and Listings Per Person", xlab="Percent under 18", ylab = "Log(Listings Per Person)")

# log transformed listings vs. 18-34
plot(log10(ZoomMeans)~(`%18_to_34`),data=pared_ages_df,main = "%age 18-34 and Listings Per Person", xlab="Percent 18-34", ylab = "Log(Listings Per Person)")
...
# under 18 age band
pe_under18ZoomMeans <- cor.test(pared_ages_df$loglistings, pared_ages_df$`%under_eighteen`, method = 'pearson')
pe_under18ZoomMeans

#18-34 age band
pe_18to34ZoomMeans <- cor.test(pared_ages_df$loglistings, pared_ages_df$`%18_to_34`, method = 'pearson')
pe_18to34ZoomMeans
...
2. Log transformed listings per person and percentage of population between 18 and 34 years old: slight, negative relationship
...
ggscatter(pared_ages_df, x = "loglistings", y = "%under_eighteen", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Log Listings Per Person", ylab = "Percentage of Population Under 18", main = "Pearson's Correlation: Listings per Person and %age of Pop Under 18")

ggscatter(pared_ages_df, x = "loglistings", y = "%18_to_34", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Log Listings Per Person", ylab = "Percentage of Population 18-34", main = "Pearson's Correlation: Listings per Person and %age of Pop 18-34")
